...
def create_server_tables(supabase, guild_id):
    ...
    try:
        ...
        logger.error(f"Error during table creation for guild {guild_id}: {str(e)}")
        logger.error("Make sure you've updated the create_guild_tables function in your Supabase SQL editor.")
